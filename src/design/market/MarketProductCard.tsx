...
/**
 * Market card — compact and price-led.
 *
 * Studio's card sells the object: big soft image, colour swatches, the rating
 * as a quiet aside. This one sells the deal — the price is the largest thing on
 * it, the saving is stated in dinars as well as percent, and the rating is a
 * single number so the whole card can be shorter and the grid denser.
 */
